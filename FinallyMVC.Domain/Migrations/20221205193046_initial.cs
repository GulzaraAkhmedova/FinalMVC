    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SocialNetworkings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SocialNetworkings_People_PersonId",
                        column: x => x.PersonId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SocialNetworkings_PersonId",
                table: "SocialNetworkings",
                column: "PersonId");
        }
